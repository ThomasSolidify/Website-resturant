...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($phonenumber) && !empty($password) && is_numeric($phonenumber))
		{

			//read from database
			//added plenty of if statements to give feedback and check data
  ...
  .cancelbtn, .signupbtn {
	...
	<div id="box">
		...
		<form method="post">
			...
			<input id="text" type="text" name="phonenumber"><br><br>
